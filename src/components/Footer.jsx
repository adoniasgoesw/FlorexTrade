            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <button variant="ghost" size="icon">
                  <BsInstagram className="w-6 h-6 hover:text-indigo-400 hover>-trasnlate-y-1 transition2" />
                </button>
                <button variant="ghost" size="icon">
                  <FaFacebook className="w-6 h-6 hover:text-indigo-400 hover>-trasnlate-y-1 transition2" />
                </button>
                <button variant="ghost" size="icon">
                  <BsLinkedin className="w-6 h-6 hover:text-indigo-400 hover>-trasnlate-y-1 transition2" />
                </button>
              </div>
            </div>
